...
void drawCloud()
{
    ...
    glScalef(cloudScale, cloudScale - 0.6, cloudScale);  // = glScalef(1, 0.4, 1);
...
void drawScene()
{
    ...
    glTranslatef(4, 3, 0);
    glScalef(sunScale, sunScale, sunScale - 0.9); // glScalef(1, 1, 0.1);
    ...
    glRotatef(cloudRotate, 0.0, 1.0, 0.0);
    drawCloud();
    glPopMatrix();
...
int main(int argc, char** argv)
{
    ...
    //Create the window
    glutCreateWindow("Transformations - Animated Scene");
    initRendering();

    //Set handler functions
    glutDisplayFunc(drawScene);
    glutReshapeFunc(handleResize); // handles resizing the output window
